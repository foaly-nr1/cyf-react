...
const PrivacyPolicy = (
  <div>
    <p>
      ...
      <a href="https://codeyourfuture.io">https://codeyourfuture.io</a> and
      served by Code Your Future with publicly-listed address of 106 Oxley
      Close, London, SE1 5HP and governs the privacy of its users who choose to
      use it. It explains how we comply with the GDPR (General Data Protection
      Regulation), the DPA (Data Protection Act) [pre GDPR enforcement] and the
    ...
    <p>
      ...
      website and its third parties (if any) interact with you and your computer
    ...
    <p>
      ...
      comes into effect from May 2018. We will update this policy accordingly
    ...
    <p>
      ...
      computer’s hard drive in order to track and monitor your engagement and
    ...
    <p>
      ...
      undertaken to ensure only genuine downloads are available users are
      advised to verify their authenticity using third-party anti-virus software
      or similar applications. We accept no responsibility for third party
      downloads and downloads provided by external third-party websites and
    ...
    <p>
      ...
      risk. Your personal information is kept private and stored securely until
      a time it is no longer required or has no use. Where we have clearly
      stated and made you aware of the fact, and where you have given your
      express permission, we may use your details to send you products/services
    ...
    <p>
      ...
      on social media platforms users are advised to verify authenticity of such
      profiles before engaging with or sharing information with such profiles.
      We will never ask for user passwords or personal details on social media
      platforms. Users are advised to conduct themselves appropriately when
      engaging with us on social media. There may be instances where our website
      features social sharing buttons, which help share web content directly
      from web pages to the respective social media platforms. You use social
      sharing buttons at your own discretion and accept that doing so may
      publish content to your social media profile feed or page. You can find
      further information about some social media privacy and usage policies in
    ...
    <table style={{width: 1000}}>
      ...
      <tr>
        ...
        <th>means Germán Bencci.</th>
      </tr>
      <tr>
        <th>Register of Systems</th>
        <th>
          means a register of all systems or contexts in which personal data is
    ...
    <ul>
      ...
      <li>Google Privacy Polic</li>
      <li>Linkedin Privacy Policy</li>
      <li>Pipedrive Privacy Policy</li>
...
const Privacy = () => (
  <main>
    <TopSection title="Privacy Policy" content={PrivacyPolicy} />
  </main>
);
