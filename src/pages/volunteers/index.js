...
const Volunteers = () => {
  const volunteersText = (
    <div>
      <p>Welcome to a community where your knowledge and experience will help to transform the lives of refugees in the UK.</p>
      ...
      <div className="section-bottom-link">
        <Link className="big-link-3 btn" to="/apply/mentor" target="_blank" rel="noopener noreferrer">
          Become a Mentor
        </Link>
      </div>

      <p>
        Or you can become a volunteer and help us support the expansion of the organisation. No matter where you are in the UK, with your help we’ll create a local program to serve local refugee
        communities.
      </p>
