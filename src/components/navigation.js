  ...
  render() {
    return (
      <Navbar collapseOnSelect>
        ...
        <Navbar.Collapse>
        <Nav pullRight>
          <NavItem eventKey={1} href="/students">Students</NavItem>
          <NavItem eventKey={2} href="/volunteers">Volunteers</NavItem>
          <NavItem eventKey={3} href="/partners">Partners</NavItem>
          <NavItem eventKey={4} className="scroll" href="index.html#about-us">About us</NavItem>
